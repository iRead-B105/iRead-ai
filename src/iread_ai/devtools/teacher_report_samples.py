...
TEACHER_REPORT_SAMPLES: tuple[TeacherReportSample, ...] = (
            ...
            "featureProfiles": [
                {
                    ...
                    "previousWeaknessScore": 0.54,
                },
                {
                    "featureCode": "SENTENCE.PHRASE_BOUNDARY",
                    "featureLabel": "긴 문장 호흡",
                    "accuracyRate": 0.58,
                    "avgPronunciationScore": 64.0,
    ...
    TeacherReportSample(
        ...
        payload={
            ...
            "featureProfiles": [
                {
                    "featureCode": "WORD.AUTOMATICITY",
                    "featureLabel": "읽기 자동화 속도",
                    "accuracyRate": 0.90,
                    "avgPronunciationScore": 91.0,
